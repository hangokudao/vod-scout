...
현재 작업: **공개된 v0.5.0-rc.1 자산 유지 · 정식 v0.5.0 로컬 패키지·SBOM·checksums·CDP 화면 스모크 PASS · GitHub 공개 진행 · 자동 GPU→CPU 전환 DEFERRED · G7 disabled**
...
- 정식 v0.5.0 unsigned NSIS는 `595,413,873` bytes/SHA-256 `abd3c2ea3b49673b438880363995bd750ef36d788a35bd907f6255f10b1f4221`, SBOM은 `615,471` bytes/SHA-256 `50cffc7ba05f33c0a55262296a0c346898a06c4193c255d3b99783ace20f2639`다. `SHA256SUMS.txt`와 일치하며 updater 자산은 없다.
- CDP 복구 스모크는 `로컬 파일` 탭과 `section[aria-label="음성 인식 설정"]`을 bounded wait해 메인 화면·0.5.0·Auto/GPU/CPU·CPU 사용량을 확인했다. 스크린샷 SHA-256은 `6e48040201047e21b67defd1963819dc266d9dc92f0726f736cf1e8881f80691`, 증거 경로는 `C:\Users\myhan\AppData\Local\Temp\vod-scout-v050-cdp-smoke-retry-20260822-022500-fbf8d7b`이며 기존 데이터 지문은 일치한다.
